      ...
      if current_chunk:
        ...
        if len(current_chunk) == 1 or rng.random() < 0.5:
          ...
          for j in range(random_start, len(random_document)):
            ...
            sentences_ending_b.append(len(random_document[j]))
        ...
        # adding [CLS] into the first sentence of segment A
        # adding [SEP] into the last sentence of segement A
        # adding [SEP] into the last sentence of segment B
...
def truncate_seq_pair(tokens_a, tokens_b,sentences_ending_a,sentences_ending_b,max_num_tokens, rng):
  ...
  while True:
    ...
    trunc_endings = sentences_ending_a if len(tokens_a) > len(tokens_b) else sentences_ending_b
